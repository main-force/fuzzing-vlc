...
#define CONFIGURE_LINE "./configure  '--prefix=/root/fuzzing_vlc/vlc-3.0.7.1/install' '--disable-a52' '--disable-lua' '--disable-qt' '--disable-avcodec' '--disable-swscale' '--disable-alsa' '--with-sanitizer=address' 'CC=afl-clang-fast' 'CXX=afl-clang-fast++'"
...
#define VLC_COMPILE_HOST "2907b3438735"
